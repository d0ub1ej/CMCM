...
<table cellpadding="0" cellspacing="0" class="t1">
    <tbody>
        ...
        <tr>
            ...
            <td class="td8" valign="middle">
                <p class="p3">230,000</p>
            </td>
            <td class="td8" valign="middle">
                <p class="p3">138,460</p>
            </td>
            <td class="td9" valign="middle">
                <p class="p1">학생회계</p>
            </td>
        ...
        <tr>
            ...
            <td class="td8" valign="middle">
                <p class="p3">690,000</p>
            </td>
            <td class="td8" valign="middle">
                <p class="p3">532,000</p>
            </td>
            <td class="td9" valign="middle">
                <p class="p1">학생회계</p>
            </td>
        ...
        <tr>
            ...
            <td class="td14" valign="middle">
                <p class="p3"><strong>1,840,000</strong></p>
            </td>
            <td class="td14" valign="middle">
                <p class="p3"><strong>1,247,840</strong></p>
            </td>
